...
SENSOR(W1Temps,  PV1PhiSect1,               'F','C')     \
SENSOR(W1Temps,  PV5PhiSect13,              'F','C')     \
SENSOR(W1Temps,  PV6PhiSect16,              'F','C')     \
SENSOR(W1Temps,  PV7PhiSect19               'F','C')     \
SENSOR(W1Temps,  PV3PhiSect7,               'F','C')     \
SENSOR(W1Temps,  PV4PhiSect10               'F','C')     \
SENSOR(W1Temps,  PV8PhiSect22               'F','C')     \
SENSOR(W1Temps,  PV2PhiSect4,               'F','C')     \
